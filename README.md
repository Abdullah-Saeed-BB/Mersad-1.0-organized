...
4. بعد تشغيل التطبيق، وعند فتح **مِداد** لأول مرة، سيُطلب منك إدخال مفتاح واجهة برمجة تطبيقات (API Key) الخاص بـ **Gemini**. يمكنك الحصول على مفتاح مجاني من خلال **Google AI Studio** باتباع الخطوات التالية:
...
## محتوى اضافي
 - كيف بنيت وكيل مِداد | [في ثريد في إكس (تويتر)](https://x.com/Abdullah_SBB/status/2079600721498865848)
